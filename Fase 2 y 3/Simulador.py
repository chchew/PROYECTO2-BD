...
def simulacion():
	...
	while loop != 0:
		...
		while num_productos != 0:
			...
			cur.execute('INSERT INTO public."Ventas Especificas"(codigo_vn, hora, "numero de factura ", dinero_generado, codigo_ep, codigo_cl, codigo_mc, precio, date) VALUES (%s, %s, %s, 15, %s, %s, %s, %s, %s);',(venta,time, factura,empleado_ran,cliente_ran,producto_ran,precio,realdate))
