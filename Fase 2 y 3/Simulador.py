    ...
    while i < entradas:
        if e == 1:
            ...
            for r in rows_pr:
                ...
                r = r.strip("(")
                precio = r.strip(",)")
            cur.execute('INSERT INTO public."Ventas Especificas"(codigo_vn, hora, "numero de facturas", dinero_generado, codigo_ep, codigo_cl, codigo_mc, precio, date)VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s);'\
